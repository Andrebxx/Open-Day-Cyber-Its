...
<body>
    ...
    <div class="team-footer-box">
        <span class="team-label">Squadra:</span>
        <span class="team-name"><?php echo htmlspecialchars($_SESSION['teamName']); ?></span>
    </div>
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function startClassifica() {
                ...
                // Delay podio
                const baseDelay = 5000 * items.length;
                const delay3 = baseDelay;
                const delay2 = baseDelay + 5000;
